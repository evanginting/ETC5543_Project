...
```{r corplot, fig.cap = "Correlation Matrix Plot of Critical Elements", out.width = "60%", fig.width = 5, fig.height = 5, fig.align = "center"}
res_cor_cop <- alldata %>% 
...
corr_cop <- cor(res_cor_cop[,3:50]) # excluding REE, MREE, LREE, REEY in the corrplot
