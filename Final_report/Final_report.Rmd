...
```{r corrmat, fig.cap = "Correlation Matrix of All Variables", fig.align = 'center', out.width="100%", out.height="45%", fig.show = 'hold'}
...
# Acknowledgement
The authors would like to thank Kane Maxwell (kane.maxwell@matrixgeoscience.com) and Limin Xu (limin.xu@matrixgeoscience.com) from Matrix Geoscience who have guided authors during this study. All codes in this study can be accessed through [GitHub](https://github.com/evanginting/ETC5543_Project). 
