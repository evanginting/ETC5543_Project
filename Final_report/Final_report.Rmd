...
corr_plots[4][[1]]
```
Based on this strata division, the raw data will be split to training and testing set with 2/3 proportion.

### Machine learning methods
Two main machine learning method are primarily utilised in this project:
...
Hyperparameter tuning is a critical step in optimising machine learning models, where the goal is to find the best combination of parameter setting that maximises predictive performance. In this study, hyperparameters were carefully adjusted under the Tidymodels framework in R. Three key hyperparameters were the top prioritized in tuning:
