...
\addlinespace
\cellcolor{gray!10}{HREE} & \cellcolor{gray!10}{XGBoost} & \cellcolor{gray!10}{Model with high variable importance} & \cellcolor{gray!10}{Pb, Sc} & \cellcolor{gray!10}{3.38} & \cellcolor{gray!10}{2.45} & \cellcolor{gray!10}{0.37} & \cellcolor{gray!10}{0.39}\\
\bottomrule
\end{tabu}
\end{table}
