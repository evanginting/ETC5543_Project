...
\hypersetup{
            pdftitle={Critical Elements in Coal Mine Waste},
            pdfborder={0 0 0},
            breaklinks=true}
...
\title{Critical Elements in Coal Mine Waste}
...
\makeatother
  ...
  \email{\href{mailto:BusExo-Econometrics@monash.edu}{\nolinkurl{BusExo-Econometrics@monash.edu}}}
...
\begin{figure}
\centering
\includegraphics{Final_report_files/figure-latex/histogram-1.pdf}
