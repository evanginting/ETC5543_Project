...
results_ree_test_df <- results_test %>%
  ...
  select(method, model_scenarios, elements, RMSE, MAE, MAPE, R_Square)
...
ree_rmse_value <- results_ree_test_df[2,4]
ree_rsq_value <- results_ree_test_df[2,7]
ree_mae_value <- results_ree_test_df[2,5]
ree_mape_value <- results_ree_test_df[2,6]
...
results_test_best <- results_test %>%
  ...
  annotate("text", x = 390, y = 45, label = paste("RMSE: ", round(ree_rmse_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 390, y = 30, label = paste("MAE: ", round(ree_mae_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 390, y = 15, label = paste("MAPE: ", round(ree_mape_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 390, y = 0, label = paste("R-squared: ", round(ree_rsq_value, 2)), size = 5, hjust = 1)
...
hree_rmse_value <- results_hree_test_df[2,4]
hree_rsq_value <- results_hree_test_df[2,7]
hree_mae_value <- results_hree_test_df[2,5]
hree_mape_value <- results_hree_test_df[2,6]
...
results_hree_test_best <- results_hree_test %>%
  ...
  theme(axis.title.x = element_text(size = 20),            # Increase X-axis title size
        axis.title.y = element_text(size = 20)) +          # Increase Y-axis title size
  # Annotate the plot with the metrics
  annotate("text", x = 32, y = 7, label = paste("RMSE: ", round(hree_rmse_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 32, y = 5, label = paste("MAE: ", round(hree_mae_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 32, y = 3, label = paste("MAPE: ", round(hree_mape_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 32, y = 1, label = paste("R-squared: ", round(hree_rsq_value, 2)), size = 5, hjust = 1)
...
lree_rmse_value <- results_lree_test_df[4,4]
lree_rsq_value <- results_lree_test_df[4,7]
lree_mae_value <- results_lree_test_df[4,5]
lree_mape_value <- results_lree_test_df[4,6]
...
results_lree_test_best <- results_lree_test %>%
  ...
  theme(axis.title.x = element_text(size = 20),            # Increase X-axis title size
        axis.title.y = element_text(size = 20)) +          # Increase Y-axis title size
  # Annotate the plot with the metrics
  annotate("text", x = 290, y = 45, label = paste("RMSE: ", round(lree_rmse_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 290, y = 30, label = paste("MAE: ", round(lree_mae_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 290, y = 15, label = paste("MAPE: ", round(lree_mape_value, 2)), size = 5, hjust = 1) +
  annotate("text", x = 290, y = 0, label = paste("R-squared: ", round(lree_rsq_value, 2)), size = 5, hjust = 1)
