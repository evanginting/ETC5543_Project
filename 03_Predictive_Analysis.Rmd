...
lree_rmse_value <- results_lree_test_df[2,5]
lree_rsq_value <- results_lree_test_df[2,8]
lree_mae_value <- results_lree_test_df[2,6]
lree_mape_value <- results_lree_test_df[2,7]
